...
1\. Clone o repositório do Projeto \[Conta Bancária](https://github.com/kauaalves7163- collab/conta\_bancaria) dentro da pasta do \*Workspace\* do Eclipse/STS



```bash

git clone https://github.com/kauaalves7163-collab/conta\_bancaria
...
Desenvolvido por \[\*\*Kaua\*\*](https://github.com/kauaalves7163-collab/conta\_bancaria)
